...
const styles = require('./styles/Profiles');
...
module.exports = class Profiles extends React.Component {
      ...
      return (
        <div>
          ...
          <section className={styles.friends}>
            ...
            <p className={styles.scrollDown}>{"Scroll down to view the games you have in common."}</p>
  ...
  render() {
    return (
      <div className={styles.component}>{this.renderInner()}</div>
    );
  }
}
